...
class Ruche
{
     ...
     * @ORM\OrderBy({"dateDeplacement" = "DESC"})
     * @var type 
     */
     ...
     * Add localisation
     *
     * @param \BEE\Services\BeeeaseBundle\Entity\Localisation $localisation
     * @return Ruche
     */
    public function addLocalisation(\BEE\Services\BeeeaseBundle\Entity\Localisation $localisation)
    {
     ...
     * @param \BEE\Services\BeeeaseBundle\Entity\Localisation $localisation
     */
    public function removeLocalisation(\BEE\Services\BeeeaseBundle\Entity\Localisation $localisation)
    {
