 ...
 * Rucher Manager
 *
 * File that manage repository request for Rucher Entity
 *
 ...
 *  Rucher Class
 */
class RucherManager extends BaseManager {
    ...
    public function getRepository() {
        return $this->em->getRepository('BEEServicesBeeeaseBundle:Rucher');
    }
